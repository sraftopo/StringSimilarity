/**
 * Simplified AI-Powered Greek Name Database Semantic Search Library with MSSQL Integration
 * Uses custom similarity algorithms without TensorFlow.js for easier deployment
...
class AINameDBSearcherSimple {
  constructor(options = {}) {
    ...
    console.log("✅ Simplified AI Name Database Searcher initialized");
  }
  ...
  async dispose() {
    ...
    console.log("AINameDBSearcherSimple disposed");
  }
}

// Export the class
module.exports = AINameDBSearcherSimple;
...
if (require.main === module) {
  (async () => {
    try {
      ...
      const searcher = new AINameDBSearcherSimple({
        batchSize: 500,
      ...
      console.log(
        "AI Name Database Checker with MSSQL (Simplified) - Test Results"
      );
      console.log(
        "==============================================================="
      );
